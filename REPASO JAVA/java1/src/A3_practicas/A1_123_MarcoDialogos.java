...
public class A1_123_MarcoDialogos extends JFrame {
	public A1_123_MarcoDialogos() {
		...
		laminaMensaje = new A2_123_LaminaBotones("Mensaje", new String[] {
			"Cadena","Ícono","Componente","Otros","Objects"
		});
		...
		//
		laminaOpciones = new A2_123_LaminaBotones("Opción", new String[] {
			"String[]","Icon[]","Object[]"	
		});
		...
		/////////////LÁMINA SUR DONDE VA EL BOTÓN DE MOSTRAR 
	...
	// MÉTODOQUE PROPORCIONA EL MENSAJE, SERA DE TIPO OBJECT YA QUE NOS PROPORCIONARÁ OBJETOS 
	...
	private class AccionMostrar implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(laminaTipo.dameSeleccion().equals("Mensaje")) {
				JOptionPane.showMessageDialog(A1_123_MarcoDialogos.this, dameMensaje(), "Título", 0);
			}
			else if(laminaTipo.dameSeleccion().equals("Confirmar")) {
				JOptionPane.showConfirmDialog(A1_123_MarcoDialogos.this, dameMensaje(),"Título",0,0);
			}
			else if(laminaTipo.dameSeleccion().equals("Entrada")) {
				JOptionPane.showInputDialog(A1_123_MarcoDialogos.this, dameMensaje(),"Título",0);
			}
			else if(laminaTipo.dameSeleccion().equals("Opción")) {
				JOptionPane.showOptionDialog(A1_123_MarcoDialogos.this, dameMensaje(),"Título", 0, 0, null, null, null);
			}
		}
	...
	private Component componenteMensaje = new LaminaEjemplo(); //hace referencia a la lámina que nos devuelve el JOptionPane
}
...
class LaminaEjemplo extends JPanel{
	public void paintComponent(Graphics g) {
		...
		Graphics2D g2 = (Graphics2D)g;
		                           //Rectangle2D.Double(0,0,getWidth(),getHeight()) = esta clase pedía como parámetros en el constructor(eje x, eje y, ancho y alto). 
