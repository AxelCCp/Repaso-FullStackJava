...
class LaminaLibre3 extends JPanel{
	public LaminaLibre3() {
		//LE DECIMOS A LA LÁMINA QUE VAMOS A TRABAJAR CON UNA DISPOSICIÓN LIBRE.
		setLayout(new EnColumnas());
		JLabel nombre = new JLabel("Nombre: ");
		JLabel apellido = new JLabel("Apellido: ");
		JLabel edad = new JLabel("Edad: ");
		JTextField cNombre = new JTextField(); //NO PONEMOS PARÁMETRO DE TAMAÑO,YA Q LO PONEMOS EN SETBOUNDS()
