//UN CONTENEDOR (MARCO) CON DOS LAMINAS SUPERPUESTAS, CADA LAMINA CON DIFERENTE DISPOSICIÓN LAYOUT
...
class MarcoLayout3 extends JFrame{
	public MarcoLayout3() {
		...
		add(lamina1,BorderLayout.NORTH);//PARA QUE NO TAPE A LA OTRA LÁMINA
		LaminaLayout4 lamina2 = new LaminaLayout4();
		add(lamina2,BorderLayout.SOUTH);//PARA QUE NO TAPE A LA OTRA LÁMINA
	}
}

//LÁMINA CON DISPOSICIÓN LEFT
