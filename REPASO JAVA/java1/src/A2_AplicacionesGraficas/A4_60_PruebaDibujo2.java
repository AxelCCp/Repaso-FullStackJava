...
class LaminaConFiguras2 extends JPanel{
	public void paintComponent(Graphics g) {
		...
		//AQUÍ USAMOS EL PRINCIPIO DE SUSTITUCIÓN PARA INSTANCIAR Y LUEGO LE DECIMOS QUE ES IGUAL A UN OBJ DE TIPO Rectangle2D.Double 
		...
		double centroEnX = rectangulo.getCenterX();//ALMACENAMOS EL EJE X DEL CENTRO DEL RECTÁNGULO. 
		double centroEnY = rectangulo.getCenterY();//ALMACENAMOS EL EJE Y DEL CENTRO DEL RECTÁNGULO. 
