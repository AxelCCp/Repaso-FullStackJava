...
class LaminaSlider2 extends JPanel{
	public LaminaSlider2() {
		...
		control.setPaintLabels(true);//PINTA LOS RÓTULOS
	...
	private class EventoSlider implements ChangeListener{
		...
		public void stateChanged(ChangeEvent arg0) {
			// TODO Auto-generated method stub
			contador++;
			System.out.println("Estás manipulando el JSlider " + contador);
			System.out.println("Estás manipulando el JSlider " + control.getValue());
