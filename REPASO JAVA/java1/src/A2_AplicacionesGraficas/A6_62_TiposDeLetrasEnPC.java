...
public class A6_62_TiposDeLetrasEnPC {
	public static void main(String []args) {
		...
		//getLocalGraphicsEnvironment(): devuelve el entorto gráfico local
		...
		if(estaLaFuente==true) System.out.println("Sí está la fuente");
		else System.out.println("No está la fuente");
	}
}
