...
class LaminaMuelle extends JPanel{
	public LaminaMuelle() {
		...
		add(boton2);
		add(boton3);
		//LE DEDIMOS A LA LÁMINA QUE USE UNA DISPOSICIÓN DE TIPO SPRINGLAYOUT
		SpringLayout milayout = new SpringLayout();
		setLayout(milayout);
		//ESTABLECEMOS El MUELLE
		Spring miMuelle = Spring.constant(0, 10, 50); //MUELLE FLEXIBLE 
		Spring miMuelle2 = Spring.constant(10); //MUELLE RÍGIDO
		//COLOCAMOS EL MUELLE ENTRE LOS BOTONES Y TAMBN LA LÁMINA
