...
class PanelAccion extends JPanel{
	...
	class AccionColor extends AbstractAction{
		...
		public void actionPerformed(ActionEvent e) {
			//POR MEDIO DE LA CLAVE, ALMACENAMOS EN "C" LA INFORMACIÓN DE colorBoton.
			Color c = (Color) getValue("Color_de_Fondo");
			setBackground(c);
			System.out.println("Nombre: " + getValue(Action.NAME));//IMPRIME EL NOMBRE
			System.out.println("Descripción: " + getValue(Action.SHORT_DESCRIPTION));//IMPRIME DESCRIPCIÓN
